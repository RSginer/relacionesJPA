 ...
 * @author Rubén
 */
@WebServlet(name = "EmpleadosController",
        loadOnStartup = 1,
...
public class EmpleadosController extends HttpServlet {
    ...
    public void obtenerEmpleados(HttpServletRequest request, HttpServletResponse response){
                try {
                    System.out.print(this.empleadosCRUDService.getTodos().toArray().toString());
            request.getSession().setAttribute("listaEmpleados", this.empleadosCRUDService.getTodos());
